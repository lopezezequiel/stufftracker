...
import WorkflowTemplateController from './controllers/WorkflowTemplateController';
...
app.use('/api/workflow-template', WorkflowTemplateController());
app.use('/api/product-template', ProductTemplateController());
